...
** straight: not default of emacs. requiring bootstrap here
   #+BEGIN_SRC emacs-lisp
     (let ((bootstrap-file
    ...
    #+BEGIN_SRC  emacs-lisp
      ...
      (use-package minuet
        ...
        (
         ...
         ("C-<tab>" . #'minuet-next-suggestion) ;; invoke completion or cycle to previous completion
